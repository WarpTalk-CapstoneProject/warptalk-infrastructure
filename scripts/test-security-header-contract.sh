...
grep -Fq "style-src 'self' 'unsafe-inline' https://accounts.google.com/gsi/style" "$caddy"
...
grep -Fq "style-src 'self' 'unsafe-inline' https://accounts.google.com/gsi/style" "$traefik"
