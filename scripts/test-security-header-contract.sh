...
grep -Fq "script-src 'self' 'unsafe-inline' blob: https://accounts.google.com/gsi/client" "$caddy"
...
grep -Fq "script-src 'self' 'unsafe-inline' blob: https://accounts.google.com/gsi/client" "$traefik"
