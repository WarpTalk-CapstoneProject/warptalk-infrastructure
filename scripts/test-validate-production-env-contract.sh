...
for contract in CHANGE_ME duplicate 0600 JWT_SECRET GRPC_INTERNAL_SECRET IMAGE_TAG INFRA_PRIVATE_IP STRIPE_WEBHOOK_SECRET GOOGLE_CLIENT_ID ALERT_EMAIL_TO; do
